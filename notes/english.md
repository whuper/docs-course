...
that只能引导限制性定于从句(不加逗号的),因此,**在引导定语从句时,that前面不能有逗号**
...
表位置的副词放在句首时,如主语是代词,不倒装,如：
1.Here it is!
表位置的副词放在句首时,如主语是名词,要用全部倒装,如：
2.Here is your ticket.
...
情态动词是表达感情和态度的动词，有一定的汉语意思，如：must （必须），may ( 可能），can ( 能，会）。

它没有人称和数的变化（但有**时态**的变化），后面加原形动词才能作谓语。

如：He can speak English. They can speak English.


助动词，顾名思义，帮助动词的词。它本身无汉语意思，仅帮助动词构成不同的时态和语态。如：He will go to Beijing tomorrow. 

will 是助动词，加上go构成谓语，组成将来时。

He is respected by the Chinese people. 

is 是助动词，和 respected一起构成谓语，组成被动语态，表示被动。

另外，有的助动词有人称和数的变化。

如：He does not study English. does 是助动词，主语是He，第三人称单数，所以从do变成does。
...
> 问： Don't you dare……的问题我在词典上查到dare可做情态动词和一般动词,用法为dare do sth.或dare to do sth.
> 我个人觉得Don't you dare 中的dare为一般动词,要用dare to do sth.的用法,但词典例句为Don't you dare talk to me like that?

> 答： 楼主真细心啊!我刚刚也去翻了下词典,词典上注明了这个**don't you dare**是在口语里用的.
> 在口语里就对语法不严格啦~不过如果严格的语法这样说应该就不对了.

> 来自 https://easylearn.baidu.com/edu-page/tiangong/questiondetail?id=1711532417888609313&fr=search
